...
CreateThread(function()
    ...
    LuckyWheelZone:onPlayerInOut(function(isPointInside)
        if isPointInside then
			text = "<b>The Diamond Casino & Resort</p>Lucky Wheel</b>"
...
RegisterNetEvent('ry::casinoLuckyWheelHeader', function()
    exports['qb-menu']:showHeader({
        ...
        },
        {
			...
			txt = "",
			params = {
                event = "ry::casinoLuckyWheelHeader"
            }
        },
    })
end)
...
RegisterNetEvent("luckywheel:client:startWheel", function() 
	QBCore.Functions.TriggerCallback('ry::server:HasVIPMembership', function(HasItem)
		if HasItem then 
			TriggerServerEvent("luckywheel:getwheel")
		else
...
RegisterNetEvent('ry:Luckywheel:winCar', function(plate)
